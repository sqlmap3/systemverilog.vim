...
syntax match svTimeUnitHash  "#[0-9_]\+\s*\zs\(fs\|ps\|ns\|us\|ms\|s\|FS\|PS\|NS\|US\|MS\|S\)\>" containedin=ALL
syntax match svTimeUnitPlain "\<[0-9_]\+\s*\zs\(fs\|ps\|ns\|us\|ms\|s\|FS\|PS\|NS\|US\|MS\|S\)\>" containedin=ALL
